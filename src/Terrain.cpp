...
Terrain::Terrain() {
	...
	pt4.pos = glm::vec3(-5.0f, -3.0f, 0.0f);
	pt5.pos = glm::vec3(5.0f, -3.0f, 0.0f);
	pt6.pos = glm::vec3(5.0f, -3.0f, -10.0f);
	pt7.pos = glm::vec3(-5.0f, -3.0f, -10.0f);
