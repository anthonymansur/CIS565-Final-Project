...
__device__ float TEMPERATURE_ALPHA = 8e-4;      // temperature diffusion coefficient                                 // TUNABLE
__device__ float TEMPERATURE_GAMMA = -4e-10;     // radiative cooling coefficient                                      // TUNABLE
...
__device__ float TAU = 20000.f;                   // temperature change per pass of wood combusted              // TUNABLE
